  ...
  return (
      <div className='contact section-p'>
          <div className="container">
              ...
              <form action="" className="contact-form mx-auto" onSubmit={handleSubmit}>
                  <div className="form-elem">
                      <input type="text" value={formData.name} className='form-control'
                      placeholder='Name' onChange={handleChange} id='name'
                      />
                  </div>
                  <div className="form-elem">
                  ...
                  <div className="form-elem">
                    <textarea rows="2" value={formData.message} className='form-control'
                      placeholder='Message' onChange={handleChange} id='message'></textarea>
                  </div>
